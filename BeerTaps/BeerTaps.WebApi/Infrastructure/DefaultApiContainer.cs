...
using BeerTaps.ApiServices.Services;
using BeerTaps.Documentation.Installers;
using BeerTaps.Domain;
using BeerTaps.WebApi.Handlers;
using BeerTaps.WebApi.Hypermedia;
using BeerTaps.WebApi.Infrastructure.Installers;
using BeerTaps.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;

namespace BeerTaps.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
	    ...
	    readonly Assembly _beerTapsAssembly = typeof(IBeerTapsService).Assembly;
                ...
                .Install(new IWindsorInstaller[]
                         {
                             ...
                             new ResourceMapperInstaller(_resourceMappersAssembly), new BeerTapsMapperInstaller(_beerTapsAssembly),
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<BeerTapsApiUser, NullUserContext>>();
        }
